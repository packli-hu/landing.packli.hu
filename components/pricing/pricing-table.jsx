  ...
  return (
    <section className="py-24 bg-zinc-50 dark:bg-zinc-950 border-b border-border/50">
      <div className="container mx-auto px-6 grid gap-5">
        ...
        <div className="grid grid-cols-3 gap-2.5 md:grid-cols-5 2xl:grid-cols-6">
                        ...
                        <tr key={key} className="even:bg-muted">
                          <td className="table-border-s max-w-[12%] !px-5 !py-3.5">
                            <div className="text-2sm font-medium leading-none ">
                              ...
                              -{" "}
                              {pricing.internal[selectedProvider].weights[key]}{" "}
                              kg
                            </div>
                          </td>
                          {Object.keys(
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-5 lg:items-end">
          <div className="flex flex-col justify-center gap-2">
            ...
            <div className="flex items-center gap-2 text-sm font-normal ">
              <FormattedMessage id={"CONTRACT.INSURANCE.HEADER.DESCRIPTION"} />
            </div>
          </div>
        </div>
            ...
            <p className="text-sm ">
              <FormattedMessage
                ...
                values={{
                  ...
                  fee: Math.ceil(pricing.insurance.fee * (1 - discount / 100)),
                }}
              />
            </p>
          </CardContent>
